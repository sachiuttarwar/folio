...
{{"executiveSummary":["b1","b2","b3","b4","b5"],"companyOverview":"string","financialPerformance":"string","industryPositioning":"string","keyRisks":["r1","r2","r3","r4","r5"],"bullCase":"string","bearCase":"string","baseCase":"string","valuationDiscussion":"string","recommendation":"BUY|HOLD|AVOID","confidence":"LOW|MEDIUM|HIGH","recommendationRationale":"string","investmentSignals":[{{"signal":"string","direction":"positive|negative|neutral","detail":"string"}}],"investmentImplications":"string","financialMetrics":[{{"label":"string","value":"string","trend":"up|down|neutral"}}],"recommendationScorecard":[{{"factor":"string","score":0,"maxScore":10,"rationale":"string"}}]}}"""
